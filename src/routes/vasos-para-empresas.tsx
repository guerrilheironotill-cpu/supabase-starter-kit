...
export const Route = createFileRoute("/vasos-para-empresas")({
  head: () => ({ meta: [
    ...
    { name: "description", content: "Vasos para empresas com design moderno, alta resistência, cores personalizadas e aplicação de logotipo para ambientes corporativos." },
    { property: "og:title", content: "Vasos para Empresas: elegância e personalização — Arteno" },
    { property: "og:description", content: "Soluções personalizadas para recepções, escritórios, restaurantes e áreas externas empresariais." },
...
function VasosParaEmpresasPage() {
  return <SeoLandingPage
    ...
    features={[
      { title: "Projetos personalizados", text: "Desenvolvemos vasos nas cores da sua empresa, com possibilidade de aplicação do logotipo." },
      { title: "Design exclusivo", text: "Modelos modernos que dialogam com diferentes estilos de arquitetura corporativa." },
      { title: "Durabilidade", text: "Peças produzidas com materiais de alta resistência para ambientes internos e externos." },
      { title: "Versatilidade de tamanhos", text: "De pequenos vasos para mesas a grandes peças para áreas de destaque." },
    ]}
