...
export function SiteFooter() {
  ...
  return (
    <>
      <footer className="bg-[#1c211d] text-white">
      ...
      <button
        ...
        className="fixed bottom-5 right-5 z-40 inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform duration-300 hover:-translate-y-0.5 hover:scale-105"
      >
